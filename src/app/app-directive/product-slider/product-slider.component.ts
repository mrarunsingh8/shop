...
export class ProductSliderComponent implements OnInit {
  ...
  imageArr: Array<{id: number, name: string, mrp: number, price: number, image: string, imageR: string, isSale: boolean, isNew: boolean, isGift: boolean}> = [
  	...
  	{id: 4, name: 'Fur coat', mrp: 340, price: 243, image: 'assets/img/product1.jpg', imageR: 'assets/img/product4_2.jpg', isSale:false, isGift: true, isNew: false},
  	{id: 5, name: 'Sherwani', mrp: 510, price: 360, image: 'assets/img/product2.jpg', imageR: 'assets/img/product5_1.jpg', isSale:false, isGift: false, isNew: true},
